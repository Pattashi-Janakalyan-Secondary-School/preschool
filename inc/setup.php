<?php
  ...
  */
  ...
  function preschool_widgets_init() {

    for( $i=1; $i<=2; $i++ ) {
      register_sidebar(array(
        'name'          =>  sprintf( esc_html__( 'Sidebar Widget %s', 'preschool' ), $i),
        'id'            => 'sidebar-widget-'.$i,
        'description'   =>  esc_html__( 'Used for sidebar widget area', 'preschool' ),
        'before_widget' => '',
        'after_widget'  => '',
  ...
  if ( ! function_exists( 'preschool_custom_sizes' ) ) :
    ...
    function preschool_custom_sizes( $sizes ) {
      return array_merge( $sizes, array(
        'preschool-featured' => __( 'Featured Image', 'preschool' ),
      ) );
    }
